...
//
echo '<form action="?service=create_subject&Cid=' . $categorie_id . '" method="POST">'; // Renvoie vers la page de service d'evnoi de message avec id catégorie et Titre du nouveau sujet
